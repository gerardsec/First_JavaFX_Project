...
public class EmployeeController {
    ...
    @FXML
    private ToggleButton opcionToggle;
    ...
    private void insertEmployee (ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        try {
            EmployeeDAO.insertEmp(nameText.getText(),surnameText.getText(),emailText.getText(),phoneText.getText());
    ...
    private void opcionElegida () {
        String opcion_elegida=new String();
        if (opcionToggle.isSelected()) {
            resultArea.setText("Encendido");
            opcionToggle.setText("ON");
        }
        else {resultArea.setText("Apagado");
            opcionToggle.setText("OFF");}

...
public class EmployeeDAO {
    ...
    //INSERT an employee
    //*************************************
    public static void insertEmp (String name, String lastname, String email, String phone) throws SQLException, ClassNotFoundException {
        //Declare a DELETE statement
        String updateStmt =
              //  "BEGIN\n" +
                        "INSERT INTO employees\n" +
                        "(FIRST_NAME, LAST_NAME, EMAIL, HIRE_DATE, JOB_ID, PHONE_NUMBER)\n" +
                        "VALUES\n" +
                        "('"+name+"', '"+lastname+"','"+email+"', CURDATE(), 'IT_PROG','"+phone+"')" ;
                //        "END;";
